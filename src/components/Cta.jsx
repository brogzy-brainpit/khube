...
function Cta() {
  return (
  <div className="h-svh my-[8em] lg:h-[100svh] relative  flex items-center justify-center w-full ">
     <Section padding={false} className='relative px-5 w-full h-full'  >
        <div className='w-full h-full absolute top-0 left-0 pb-[66.66% rounded-t-[1.5em] lg:rounded-[2em] shadow-xl shadow-black/30 overflow-clip'>
           ...
           <div className='w-full bg-black/45 h-full absolute top-0 left-0'/>
            ...
            <GridColumn className='w-full h-full relative flex items-center justify-center'>
